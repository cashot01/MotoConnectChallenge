...
INSERT INTO tb_moto(modelo,placa,data_cadastro,status,usuario_id)
VALUES ('POP','ABC1234',CURRENT_DATE,'NAO_INICIADO',1), ('SPORT','XYZ5678',CURRENT_DATE,'MANUTENCAO',2);
